...
export function CTASection() {
  return (
    <section id="precios" className="relative py-24 overflow-hidden bg-linear-to-br from-slate-900 via-blue-950 to-slate-900">
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            ...
            className="group rounded-xl bg-linear-to-r from-orange-500 to-orange-600 px-10 py-4 text-lg font-bold text-white hover:from-orange-600 hover:to-orange-700 shadow-2xl transition-all flex items-center gap-2"
          >
