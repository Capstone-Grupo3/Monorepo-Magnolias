...
export function HeroSection() {
  return (
    <section className="pt-24 pb-16 bg-linear-to-br from-slate-900 via-blue-950 to-slate-900">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-left">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-linear-to-r from-orange-500 to-orange-600 px-8 py-4 text-lg font-semibold text-white hover:from-orange-600 hover:to-orange-700 shadow-xl transition-all"
            >
              Agendar demo
          ...
          <div className="flex-1">
            <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-blue-800/30 shadow-2xl">
