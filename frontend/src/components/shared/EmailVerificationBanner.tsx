...
export default function EmailVerificationBanner({ userEmail, userType }: EmailVerificationBannerProps) {
  ...
  const handleResendVerification = async () => {
    ...
    try {
      await authService.resendVerificationEmail(userEmail, userType);
      setMessage({ 
        type: 'success', 
